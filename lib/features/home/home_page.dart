...
class _MenuGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final entries = <_MenuEntry>[
      _MenuEntry('Visual Novels', Icons.book, () => context.push('/search')),
      _MenuEntry('Tags', Icons.label, () => context.push('/tags')),
      _MenuEntry('Releases', Icons.album, () => context.push('/releases')),
      _MenuEntry('Producers', Icons.business, () => context.push('/producers')),
      _MenuEntry('Staff', Icons.people, () => context.push('/staff')),
      _MenuEntry('Characters', Icons.face, () => context.push('/characters')),
      _MenuEntry('Traits', Icons.category, () => context.push('/traits')),
      _MenuEntry('Quotes', Icons.format_quote, () => context.push('/quotes')),
      _MenuEntry('Users', Icons.group, () => context.push('/users')),
    ];
    return Padding(
            ...
            .map((e) => Card(
                  child: InkWell(
                    ...
                    child: Column(
                      ...
                      children: [
                        Icon(e.icon, color: AppTheme.accent),
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return AsyncValueWidget(
      ...
      data: (d) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          SectionHeader(title: '即将发售', icon: Icons.upcoming),
          SizedBox(
            height: 150,
          ...
          SectionHeader(title: '刚刚发售', icon: Icons.new_releases),
          SizedBox(
            height: 150,
...
class _SiteLinksSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final links = <_LinkEntry>[
      ...
      _LinkEntry('API / Dumps', Icons.code, AppLinks.apiDocs),
